# app_employe.py — MODERNE CustomTkinter
...
class AppEmploye(ctk.CTk):
    ...
    def _build(self):
        ...
        for label, key in input_fields:
            ...
            if key in ("quantite","prix_unit"): e.bind("<KeyRelease>", self._update_total)
        ...
        self.status_lbl = ctk.CTkLabel(body, text="", font=ctk.CTkFont(size=11),
                                        text_color="#27ae60")
    ...
    def _on_produit(self, _=None):
        ...
        if row:
            ...
            self.lbl_stock.configure(text=info, text_color=fg)
    ...
    def _save(self):
        ...
        self.btn_pdf.configure(state="normal")
        msg = f"✅ Vente enregistrée — {total:,.0f} {MONNAIE}"
