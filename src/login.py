...
class LoginWindow(ctk.CTk):
    ...
    def _build(self):
        ctk.CTkLabel(self, text="🧃", font=ctk.CTkFont(size=56)).pack(pady=(36,4))
        ctk.CTkLabel(self, text=BOUTIQUE_NOM,
                     font=ctk.CTkFont(size=26, weight="bold")).pack()
        ctk.CTkLabel(self, text="Gestion de Stock",
                     font=ctk.CTkFont(size=13), text_color="gray").pack(pady=(2,24))
        ...
        ctk.CTkButton(frame, text="SE CONNECTER",
                      ...
                      command=self._login).pack(fill="x", padx=25, pady=(0,22))
